            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fa-solid fa-person mt-4 mb-3" aria-hidden="true"></i> service provider</h2>
                        @if(session('success'))
                    ...
                    <form action="{{ route('lessores.index') }}" method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Filter by Lessor name or email" name="name" value="{{ request('name') }}">
                    ...
                    <div class="card-body" >
                        <a href="{{ route('lessores.create') }}" class="btn btn-outline-custom btn-lg " title="Add New Lessor"  style=" background-color:#ffe468  ; color:#8cc641 " >
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th class="bg-custom  " style=" background-color:#ffe468 "  >
                                            <a href="{{ route('lessores.index', ['sort' => 'id']) }}" style=" color:#8cc641 "   >
                                                <i class="fa-solid fa-list-ol" aria-hidden="true"></i> <i class="fa fa-sort" aria-hidden="true"></i> Id
                                            </a>
                                        </th>
                                        <th class="bg-custom "  style=" background-color:#ffe468 " >
                                            <a href="{{ route('lessores.index', ['sort' => 'name']) }}" style=" color:#8cc641 "  >
                                                <i class="fa fa-font" aria-hidden="true"></i> <i class="fa fa-sort" aria-hidden="true"></i> Name
                                            </a>
                                        </th>
                                        <th class="bg-custom "  style=" background-color:#ffe468 "  >
                                            <a href="{{ route('lessores.index', ['sort' => 'email']) }}" style=" color:#8cc641 " >
                                                <i class="fa-sharp fa-solid fa-envelope" aria-hidden="true"></i> <i class="fa fa-sort" aria-hidden="true"></i> Email
                                            </a>
                                        </th>
                                        <th class="bg-custom " style=" background-color:#ffe468 ; color:#8cc641 "  ><i class="fa-solid fa-phone" aria-hidden="true"></i> Mobile</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->image)
                                            <img src="{{ asset('assit-user/images/'. $item->image) }}" alt="Lessor Image" class="img-thumbnail" style="width: 100px;">
                                            @else
