...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1><i class="fa fa-plus mt-4 mb-2" aria-hidden="true"></i> Add service provider</h1>
            <form action="{{ route('lessores.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-custom mb-4" style="background-color: #ffe468 ; color : #8cc641"  ><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
            </form>
        </div>
    </div>
</div>
