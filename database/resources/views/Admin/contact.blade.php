                ...
                <div class="card">
                    ...
                    <form action="{{ route('contact.index') }}" method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="filter by name and email" name="name" value="{{ request('location') }}">
                            <!-- استخدم "name" كااسم للحقل -->
                            <div class="input-group-append">
                                <button class="btn btn-custom" type="submit" style="background:#fee469; color:#8cc641" ><i class="fa fa-search" aria-hidden="true" style="color:#8cc641 "  ></i> Search</button>
                            </div>
                        </div>
                    </form>
