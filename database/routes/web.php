...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:User'])->group(function () {
        ...
        // Route::get('/User/userprofile', [UserprofileController::class, 'index'])->name('User.userprofile');
    ...
    Route::middleware(['role:Admin'])->group(function () {
        ...
        Route::get('/admin', [DashboardAdminController::class, 'index2'])->name('admin.index2');
