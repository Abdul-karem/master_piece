    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('userdashboard.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-custom  mb-4" style="background-color:#ffe468 ;color:  #8cc641  "   ><i class="fa fa-check" aria-hidden="true" style="color:  #8cc641" ></i> Submit</button>
            </form>
        </div>
    </div>
</div>
