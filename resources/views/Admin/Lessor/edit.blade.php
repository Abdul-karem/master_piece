...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3><i class="fa fa-pencil mt-4 mb-2" aria-hidden="true"></i> Edit service provider</h3>
            <form action="{{ route('lessores.update', $lessor->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-custom mb-4" style="background-color: #ffe468 ; color: #8cc641 "  ><i class="fa fa-check" aria-hidden="true"  ></i> Update</button>
            </form>
        </div>
    </div>
</div>
