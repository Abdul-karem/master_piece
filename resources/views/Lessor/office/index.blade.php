            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fa fa-building mt-4 mb-3" aria-hidden="true"></i>Service</h2>
                        @if(session('success'))
                    ...
                    <form action="{{ route('office.index') }}" method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="service name" name="name" value="{{ request('name') }}">
                            <!-- استخدم "name" كاسم للحقل -->
                            <div class="input-group-append">
                                <button class="btn btn-custom " type="submit" style="background-color: #ffe468  ; color : #8cc641 "    ><i class="fa fa-search" aria-hidden="true"></i> Search</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="card-body">
                        <a href="{{ route('office.create') }}" class="btn btn-outline-custom btn-lg "
                        title="Add New Office" style="background-color: #ffe468  ; color : #8cc641 "  >
